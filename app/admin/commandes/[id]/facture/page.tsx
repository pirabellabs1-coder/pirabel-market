  ...
  return (
    <>
      <div className="invoice-actions">
        <Link className="btn btn-ghost" href={`/admin/commandes/${id}`}>← Retour à la commande</Link>
        <PrintButton/>
      </div>
      ...
      <div className="invoice-sheet">
        ...
        <div className="inv-footer">
          <p><strong>Mentions légales :</strong> Pirabel, {BRAND.address}, {BRAND.country}. Entreprise individuelle / SARL (à compléter avec IFU et RCCM).</p>
          ...
          <p>En cas de retard de paiement, des pénalités au taux légal sont exigibles conformément à la réglementation en vigueur au Bénin.</p>
